...
> **En este proyecto (DESA Apps) la fuente es **Outfit** (Google Fonts), no SF Pro.** Mantener Outfit en `fonts.heading` y `fonts.body`. La jerarquía de pesos/tamaños de SF Pro se replica con Outfit.
